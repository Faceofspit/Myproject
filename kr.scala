...
class kr extends Simulation {
  ...
  val userData = csv("C:/Users/ChitragarKrishna(MJI/Music/gatling-charts-highcharts-bundle-3.9.5-bundle (1)/gatling-charts-highcharts-bundle-3.9.5/usersfile.csv").circular
 
  val login_scenario = scenario("Login")
  .feed(userData) // Inject data from the feeder
  .group("Login") {
    exec(
      http("tenantIds")
